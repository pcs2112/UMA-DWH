...
export default withMainLayout(connect(
  state => ({
    ...
    cycleHistoryData: etlCycleHistory.selectors.historyByCycleGroup(state),
    cycleHistoryFetchingError: etlCycleHistory.selectors.historyError(state),
    currentCycleGroup: etlCycleHistory.selectors.currentCycleGroup(state),
    currentCycleGroupStartDttm: etlCycleHistory.selectors.currentCycleGroupStartDttm(state),
    isCurrentStatusFetching: state.etlCurrentStatus.isFetching,
    currentStatusData: etlCurrentStatus.selectors.currentStatus(state),
    currentStatusDataTotals: etlCurrentStatus.selectors.currentStatusTotals(state),
