...
--  delete from [MWH].[ETL_HISTORY]   where [CALLING_PROC]  in (  'MWH.GET_CURRENT_ETL_CYCLE_STATUS')
...
RUN_TIME_TO_CURRENT_DATAMART_STATUS  as 'RUN-TIME to CURRENT' ,
